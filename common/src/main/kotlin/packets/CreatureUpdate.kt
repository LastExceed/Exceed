...
inline class Motion(val value: Byte) {
	companion object {
		val Idle = Motion(0)
		val DualWield1 = Motion(1)
		val DualWield2 = Motion(2)
		val Unknown_003 = Motion(3) //like daggers
		val Unknown_004 = Motion(4)
		val LongswordM2 = Motion(5)
		val FistsM1a = Motion(6) //also bare hands
		val FistsM1b = Motion(7)
		...
		val Unknown_021 = Motion(21) //same as 20
		...
		val StaffFire = Motion(30)
		val StaffFireM2 = Motion(31)
		val StaffWater = Motion(32)
